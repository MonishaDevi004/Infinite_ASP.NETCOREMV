...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
  //      => optionsBuilder.UseSqlServer("Data Source=DESKTOP-U8J1M3C\\MSSQLSERVER01;Initial Catalog=Northwind;Trusted_Connection=True;TrustServerCertificate=true;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OrderDetail>(entity =>
        {
            ...
            entity.HasIndex(e => e.OrderId, "idxOrderid");
        ...
        {
            entity.HasKey(e => e.Sid).HasName("PK__Sample__CA1E5D78FF83E3B9");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Test__3213E83FD90160BD");
...
public DbSet<EKART.DTO.ProductDTO> ProductDTO { get; set; } = default!;
}
